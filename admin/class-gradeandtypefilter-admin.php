 ...
 * @subpackage Gradeandtypefilter/admin
 */
 ...
 */
class Gradeandtypefilter_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/gradeandtypefilter-admin.css', array(), $this->version, 'all' );
